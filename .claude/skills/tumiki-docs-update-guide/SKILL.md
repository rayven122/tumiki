---
description: 機能実装後のドキュメント（スキル、CLAUDE.md）更新を支援するガイド。変更検出、スキル更新のタイミング・手順、コード例の書き方を提供。
---
...
- 機能実装後にドキュメントの更新が必要か確認したいとき
- スキルのコード例を最新の実装に合わせて更新するとき
- 新しいスキルを作成するとき
- CLAUDE.md に新機能の説明を追加するとき
