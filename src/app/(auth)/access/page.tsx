...
export default function MCPAccessManagement() {
  ...
  const handleCreateApiKey = () => {
    if (!newKeyName.trim() || selectedServers.length === 0) {
      // toast({
      //   title: "エラー",
      //   description: "API Key名とサーバーを選択してください",
      //   variant: "destructive",
      // });
      return;
    }
    ...
    // toast({
    //   title: "API Keyを作成しました",
    //   description: "新しいAPI Keyが正常に作成されました",
    // });
  };
  ...
  const handleEditApiKey = () => {
    ...
    // toast({
    //   title: "API Keyを更新しました",
    //   description: "API Keyが正常に更新されました",
    // });
  };
  ...
  const handleDeleteApiKey = () => {
    ...
    // toast({
    //   title: "API Keyを削除しました",
    //   description: "API Keyが正常に削除されました",
    // });
  };
  ...
  const handleRegenerateApiKey = (keyId: string) => {
    ...
    setShowApiKey(true);
    // toast({
    //   title: "API Keyを再生成しました",
    //   description: "新しいAPI Keyが正常に生成されました",
    // });
  };
  ...
  const copyToClipboard = (text: string) => {
    ...
    // toast({
    //   title: "コピーしました",
    //   description: "API Key URL をクリップボードにコピーしました",
    // });
  };
  ...
  const handleCreateToolGroup = (group: Omit<ToolGroup, "id">) => {
    ...
    // toast({
    //   title: "ツールグループを作成しました",
    //   description: "新しいツールグループが正常に作成されました",
    // });
  };
  ...
  const handleEditToolGroup = (group: Omit<ToolGroup, "id">) => {
    ...
    // toast({
    //   title: "ツールグループを更新しました",
    //   description: "ツールグループが正常に更新されました",
    // });
  };
  ...
  const handleDeleteToolGroup = () => {
    ...
    // toast({
    //   title: "ツールグループを削除しました",
    //   description: "ツールグループが正常に削除されました",
    // });
  };
