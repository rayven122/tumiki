                ...
                <TabsContent value="targets" className="space-y-4 pt-4">
                  <Card>
                    <CardContent className="pt-6">
                      <div className="grid gap-6">
                        <div>
                          <h3 className="text-lg font-medium">付与対象</h3>
      ...
      <CardContent className="pt-6">
        <div className="space-y-6">
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-2">
              {status ? (
                <div className="flex items-center gap-1 rounded-full bg-green-50 px-2 py-1 text-sm text-green-600">
                  <CheckIcon className="h-4 w-4" />
                  <span>有効</span>
                </div>
              ) : (
                <div className="flex items-center gap-1 rounded-full bg-red-50 px-2 py-1 text-sm text-red-600">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
              ...
              <div className="space-y-4">
                <div>
                  <div className="text-sm font-medium">ツール種別</div>
                  <div className="mt-1">
                ...
                <div>
                  <div className="text-sm font-medium">有効期限</div>
                  <div className="mt-1">
                    {expirationDate ? (
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                <div className="mb-2 text-sm font-medium">ユーザー</div>
                <div className="space-y-2">
              ...
              <div>
                <div className="mb-2 text-sm font-medium">チーム</div>
                <div className="space-y-2">
