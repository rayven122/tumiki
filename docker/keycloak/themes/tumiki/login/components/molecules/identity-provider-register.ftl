  ...
  <div style="margin-top: 0.5rem;">
    <#list providers as provider>
      <a
        ...
        style="display: flex; width: 100%; align-items: center; justify-content: space-between; overflow: hidden; border: 2px solid #000000; background-color: #ffffff; padding: 1rem 1.5rem; font-weight: 700; color: #1f2937; box-shadow: 4px 4px 0px 0px #000000; text-decoration: none; transition: all 0.2s;"
