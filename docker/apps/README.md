...
sudo systemctl list-timers tumiki-docker-prune.timer
```
...
scp docker/apps/systemd/tumiki-docker-prune.service tumiki-sakura-prod:/tmp/
scp docker/apps/systemd/tumiki-docker-prune.timer tumiki-sakura-prod:/tmp/
...
sudo install -m 644 /tmp/tumiki-docker-prune.service /etc/systemd/system/
sudo install -m 644 /tmp/tumiki-docker-prune.timer /etc/systemd/system/
