...
import type { StreamingTTSPlayer } from "@/lib/coharu/StreamingTTSPlayer";
...
// StreamingTTSPlayer インスタンス（コンポーネント間で共有）
export const coharuTTSPlayerAtom = atom<StreamingTTSPlayer | null>(null);
