      ...
      >
        ...
        <div className="relative z-10 mx-auto mt-20 max-w-6xl px-5">
          <div className="text-center">
            <motion.h1
              className="mb-6 text-2xl font-black leading-tight tracking-tight text-black sm:text-3xl md:text-6xl lg:text-7xl"
            ...
            <motion.p
              className="mx-auto mb-12 max-w-4xl text-sm font-medium leading-relaxed text-gray-600 sm:text-lg md:text-xl lg:text-2xl"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 30 }}
