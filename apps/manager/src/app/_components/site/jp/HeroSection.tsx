      ...
      <header className="fixed top-0 z-50 w-full border-b-2 border-black bg-white transition-all duration-300">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5">
          ...
          <div className="flex items-center gap-2 md:hidden">
            ...
            <button
              onClick={() => setShowModal(true)}
              className="border-2 border-black bg-black px-2 py-2 text-xs font-semibold text-white shadow-[2px_2px_0_#6366f1] transition-all duration-300 hover:-translate-x-1 hover:-translate-y-1 hover:shadow-[4px_4px_0_#6366f1]"
            >
              無料で試す
            </button>
          </div>
