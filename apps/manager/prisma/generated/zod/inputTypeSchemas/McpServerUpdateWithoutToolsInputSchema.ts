...
import { UserMcpServerConfigUpdateManyWithoutMcpServerNestedInputSchema } from './UserMcpServerConfigUpdateManyWithoutMcpServerNestedInputSchema';

export const McpServerUpdateWithoutToolsInputSchema: z.ZodType<Prisma.McpServerUpdateWithoutToolsInput> = z.object({
  ...
  mcpServerConfigs: z.lazy(() => UserMcpServerConfigUpdateManyWithoutMcpServerNestedInputSchema).optional()
}).strict();

export default McpServerUpdateWithoutToolsInputSchema;
