...
export const OrganizationInvitationUpdateWithoutOrganizationInputSchema: z.ZodType<Prisma.OrganizationInvitationUpdateWithoutOrganizationInput> = z.object({
  ...
  invitedByUser: z.lazy(() => UserUpdateOneRequiredWithoutInvitationsNestedInputSchema).optional()
}).strict();

export default OrganizationInvitationUpdateWithoutOrganizationInputSchema;
