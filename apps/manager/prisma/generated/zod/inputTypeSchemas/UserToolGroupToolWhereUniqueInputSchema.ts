...
import { z } from 'zod';
import { UserToolGroupToolToolGroupIdUserMcpServerConfigIdToolIdCompoundUniqueInputSchema } from './UserToolGroupToolToolGroupIdUserMcpServerConfigIdToolIdCompoundUniqueInputSchema';
...
export const UserToolGroupToolWhereUniqueInputSchema: z.ZodType<Prisma.UserToolGroupToolWhereUniqueInput> = z.object({
  toolGroupId_userMcpServerConfigId_toolId: z.lazy(() => UserToolGroupToolToolGroupIdUserMcpServerConfigIdToolIdCompoundUniqueInputSchema)
})
.and(z.object({
  toolGroupId_userMcpServerConfigId_toolId: z.lazy(() => UserToolGroupToolToolGroupIdUserMcpServerConfigIdToolIdCompoundUniqueInputSchema).optional(),
...
export default UserToolGroupToolWhereUniqueInputSchema;
