...
import { OrganizationGroupCreateInputSchema } from '../inputTypeSchemas/OrganizationGroupCreateInputSchema'
import { OrganizationGroupUncheckedCreateInputSchema } from '../inputTypeSchemas/OrganizationGroupUncheckedCreateInputSchema'
...
export const OrganizationGroupUpsertArgsSchema: z.ZodType<Prisma.OrganizationGroupUpsertArgs> = z.object({
  ...
  create: z.union([ OrganizationGroupCreateInputSchema,OrganizationGroupUncheckedCreateInputSchema ]),
  update: z.union([ OrganizationGroupUpdateInputSchema,OrganizationGroupUncheckedUpdateInputSchema ]),
}).strict() ;

export default OrganizationGroupUpsertArgsSchema;
