...
import { OrganizationRoleCreateInputSchema } from '../inputTypeSchemas/OrganizationRoleCreateInputSchema'
...
export const OrganizationRoleUpsertArgsSchema: z.ZodType<Prisma.OrganizationRoleUpsertArgs> = z.object({
  ...
  create: z.union([ OrganizationRoleCreateInputSchema,OrganizationRoleUncheckedCreateInputSchema ]),
  update: z.union([ OrganizationRoleUpdateInputSchema,OrganizationRoleUncheckedUpdateInputSchema ]),
}).strict() ;

export default OrganizationRoleUpsertArgsSchema;
