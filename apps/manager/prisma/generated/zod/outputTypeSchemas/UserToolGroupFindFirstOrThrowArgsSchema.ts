...
export const UserToolGroupFindFirstOrThrowArgsSchema: z.ZodType<Prisma.UserToolGroupFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ UserToolGroupScalarFieldEnumSchema,UserToolGroupScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default UserToolGroupFindFirstOrThrowArgsSchema;
