...
export const UserToolGroupUpdateArgsSchema: z.ZodType<Prisma.UserToolGroupUpdateArgs> = z.object({
  select: UserToolGroupSelectSchema.optional(),
  include: z.lazy(() => UserToolGroupIncludeSchema).optional(),
  data: z.union([ UserToolGroupUpdateInputSchema,UserToolGroupUncheckedUpdateInputSchema ]),
  where: UserToolGroupWhereUniqueInputSchema,
}).strict() ;

export default UserToolGroupUpdateArgsSchema;
