...
export const OrganizationRoleUpdateArgsSchema: z.ZodType<Prisma.OrganizationRoleUpdateArgs> = z.object({
  select: OrganizationRoleSelectSchema.optional(),
  include: z.lazy(() => OrganizationRoleIncludeSchema).optional(),
  data: z.union([ OrganizationRoleUpdateInputSchema,OrganizationRoleUncheckedUpdateInputSchema ]),
  where: OrganizationRoleWhereUniqueInputSchema,
}).strict() ;

export default OrganizationRoleUpdateArgsSchema;
