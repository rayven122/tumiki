...
export const OrganizationGroupCreateArgsSchema: z.ZodType<Prisma.OrganizationGroupCreateArgs> = z.object({
  select: OrganizationGroupSelectSchema.optional(),
  include: z.lazy(() => OrganizationGroupIncludeSchema).optional(),
  data: z.union([ OrganizationGroupCreateInputSchema,OrganizationGroupUncheckedCreateInputSchema ]),
}).strict() ;

export default OrganizationGroupCreateArgsSchema;
