...
export const McpServerFindFirstOrThrowArgsSchema: z.ZodType<Prisma.McpServerFindFirstOrThrowArgs> = z.object({
...
export default McpServerFindFirstOrThrowArgsSchema;
