...
export const McpServerUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.McpServerUpdateManyAndReturnArgs> = z.object({
...
export default McpServerUpdateManyAndReturnArgsSchema;
