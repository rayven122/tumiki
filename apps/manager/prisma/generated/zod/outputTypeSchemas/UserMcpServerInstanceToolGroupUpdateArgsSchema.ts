...
export const UserMcpServerInstanceToolGroupUpdateArgsSchema: z.ZodType<Prisma.UserMcpServerInstanceToolGroupUpdateArgs> = z.object({
  ...
  data: z.union([ UserMcpServerInstanceToolGroupUpdateInputSchema,UserMcpServerInstanceToolGroupUncheckedUpdateInputSchema ]),
  where: UserMcpServerInstanceToolGroupWhereUniqueInputSchema,
}).strict() ;

export default UserMcpServerInstanceToolGroupUpdateArgsSchema;
