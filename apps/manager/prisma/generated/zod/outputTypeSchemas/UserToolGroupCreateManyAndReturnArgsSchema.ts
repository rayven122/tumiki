...
export const UserToolGroupCreateManyAndReturnArgsSchema: z.ZodType<Prisma.UserToolGroupCreateManyAndReturnArgs> = z.object({
  data: z.union([ UserToolGroupCreateManyInputSchema,UserToolGroupCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default UserToolGroupCreateManyAndReturnArgsSchema;
