...
export const OrganizationRoleCreateArgsSchema: z.ZodType<Prisma.OrganizationRoleCreateArgs> = z.object({
  select: OrganizationRoleSelectSchema.optional(),
  include: z.lazy(() => OrganizationRoleIncludeSchema).optional(),
  data: z.union([ OrganizationRoleCreateInputSchema,OrganizationRoleUncheckedCreateInputSchema ]),
}).strict() ;

export default OrganizationRoleCreateArgsSchema;
