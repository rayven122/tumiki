...
export const TOOLS: Tool[] = [
  {
    ...
    operations: [
      {
        ...
        description: "ライブラリIDの解決",
        allowed: true,
      },
      {
        name: "get_library_docs",
        description: "ライブラリドキュメントの取得",
        allowed: true,
      },
    ],
    lastUsed: "10分前",
    ...
    admin: "情報システム部",
    stats: { requests: 312, successRate: 99.5, avgLatency: 95 },
    approved: true,
    category: "ドキュメント",
    authType: "NONE",
  },
  {
    ...
    operations: [
      ...
      { name: "export_svg", description: "SVGエクスポート", allowed: true },
    ],
    lastUsed: "3時間前",
    protocol: "MCP (Streamable HTTP)",
  ...
  },
  {
    ...
    admin: "情報システム部",
    stats: { requests: 256, successRate: 99.1, avgLatency: 120 },
    approved: true,
    category: "プロジェクト管理",
    authType: "OAuth",
  },
  ...
  },
  {
    ...
    operations: [
      { name: "query", description: "SQLクエリの実行", allowed: true },
      { name: "manage_auth", description: "認証管理", allowed: true },
      {
        name: "manage_storage",
        description: "ストレージ管理",
        allowed: false,
  ...
  },
  {
    ...
    operations: [
      ...
      {
        name: "local_search",
        description: "ローカル検索の実行",
        allowed: true,
      },
    ],
    lastUsed: "30分前",
    protocol: "MCP (Streamable HTTP)",
    endpoint: "brave-search-mcp.run.app",
    addedDate: "2026/03/01",
    admin: "情報システム部",
