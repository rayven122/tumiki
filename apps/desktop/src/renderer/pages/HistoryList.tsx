  ...
  return (
    <div className="space-y-4 p-6">
      ...
      >
        ...
        {/* テーブルヘッダー */}
        <div
          className="grid grid-cols-[80px_90px_90px_1fr_85px_56px] items-center gap-2 px-5 py-2 text-[10px]"
          style={{
        ...
        {filtered.map((item) => {
          ...
          return (
            <Link
              key={item.id}
              to={`/history/${item.id}`}
              className="grid grid-cols-[80px_90px_90px_1fr_85px_56px] items-center gap-2 px-5 py-2.5 text-xs transition-colors hover:opacity-90"
              style={{
