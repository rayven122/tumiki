  ...
  return (
    ...
    >
      <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] p-8">
        ...
        >
          <div
            className="flex w-full items-center gap-1.5 rounded-lg border px-4 py-3"
            style={{
          ...
          <div
            className="pointer-events-none absolute bottom-full left-0 z-10 mb-2 w-80 rounded-lg border px-4 py-3 text-xs shadow-lg transition-all duration-150"
            style={{
