...
// keycloakConfig.ts のモック
vi.mock("../keycloakConfig.js", () => ({
  getKeycloakServerMetadata: vi.fn(),
  getJWKS: vi.fn(),
}));

import { verifyKeycloakJWT } from "../jwtVerifierImpl.js";
import { jwtVerify } from "jose";
import { getKeycloakServerMetadata, getJWKS } from "../keycloakConfig.js";
