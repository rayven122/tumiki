  ...
  return (
    <div className="space-y-4 p-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="relative">
          ...
          <input
            ...
            className="rounded-lg py-1.5 pr-3 pl-7 text-xs outline-none"
            style={{
      ...
      >
        {/* ヘッダー行 */}
        <div
          className="grid grid-cols-[1fr_130px_100px_120px_110px_70px_70px] items-center gap-3 px-5 py-2.5 text-[10px]"
          style={{
        ...
        {filtered.length === 0 ? (
          ...
          filtered.map((user) => {
            ...
            return (
              <div
                key={user.id}
                className="grid grid-cols-[1fr_130px_100px_120px_110px_70px_70px] items-center gap-3 px-5 py-3 text-xs transition-colors hover:bg-white/[0.02]"
