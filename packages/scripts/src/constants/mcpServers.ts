...
export const MCP_SERVERS: McpServer[] = [
  ...
  {
    name: "Add MCP",
    description: "足し算 MCP サーバー - 2つの数値を足す",
    tags: ["計算", "算術", "ツール"],
    iconPath: "/logos/calculator.svg",
  ...
  {
    name: "Subtract MCP",
    description: "引き算 MCP サーバー - a から b を引く",
    tags: ["計算", "算術", "ツール"],
    iconPath: "/logos/calculator.svg",
  ...
  {
    name: "Multiply MCP",
    description: "掛け算 MCP サーバー - 2つの数値を掛ける",
    tags: ["計算", "算術", "ツール"],
    iconPath: "/logos/calculator.svg",
  ...
  {
    name: "Divide MCP",
    description: "割り算 MCP サーバー - a を b で割る（ゼロ除算エラー対応）",
    tags: ["計算", "算術", "ツール"],
    iconPath: "/logos/calculator.svg",
