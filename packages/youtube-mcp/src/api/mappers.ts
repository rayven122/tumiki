...
export const mapChannelResponse = (
  item: YouTubeApiChannelItem,
): ChannelDetails => ({
  id: item.id,
  title: item.snippet?.title ?? "",
  description: item.snippet?.description ?? "",
...
export const mapPlaylistResponse = (
...
export const mapPlaylistItem = (
  item: YouTubeApiPlaylistItemResource,
): PlaylistItem => ({
  id: item.id,
  title: item.snippet?.title ?? "",
  description: item.snippet?.description ?? "",
...
export const mapCaptionResponse = (
  item: YouTubeApiCaptionItem,
): TranscriptMetadata => ({
