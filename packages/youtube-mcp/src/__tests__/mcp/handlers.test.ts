...
describe("handleToolRequest", () => {
  ...
  describe("video tools", () => {
    ...
    test("異常系: videoツールでエラーが発生した場合にエラーを返す", async () => {
      mockHandleVideoTool.mockResolvedValueOnce(
        err(new Error("Video tool error")),
      );
  ...
  describe("channel tools", () => {
    ...
    test("異常系: channelツールでエラーが発生した場合にエラーを返す", async () => {
      mockHandleChannelTool.mockResolvedValueOnce(
        err(new Error("Channel tool error")),
      );
  ...
  describe("playlist tools", () => {
    ...
    test("異常系: playlistツールでエラーが発生した場合にエラーを返す", async () => {
      mockHandlePlaylistTool.mockResolvedValueOnce(
        err(new Error("Playlist tool error")),
      );
  ...
  describe("comment tools", () => {
    ...
    test("異常系: commentツールでエラーが発生した場合にエラーを返す", async () => {
      mockHandleCommentTool.mockResolvedValueOnce(
        err(new Error("Comment tool error")),
      );
